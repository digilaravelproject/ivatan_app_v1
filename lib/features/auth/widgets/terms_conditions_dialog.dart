        ...
        children: [
          Container(
            ...
            child: Text(
              "$number",
              style: TextStyle(
                color: isHighlighted ? AppColors.premiumGold : Colors.white70,
                fontSize: 11,
              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        // Top 3 points in a sleek dark container
                        Container(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color: _isChecked ? AppColors.premiumGold : const Color(0xFF666666),
                                      width: 1.5,
                                    ),
                                    color: _isChecked ? AppColors.premiumGold : Colors.transparent,
                                  ),
                                  alignment: Alignment.center,
                                  child: _isChecked
                                      ? const Icon(
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _isChecked ? AppColors.premiumGold : const Color(0xFF2C2C2C),
                      foregroundColor: _isChecked ? Colors.black : Colors.white38,
                      elevation: 0,

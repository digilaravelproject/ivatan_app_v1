...
class _StoryScreenState extends State<StoryScreen> {
      ...
      body: Stack(
        children: [
          ...
          if (drawingStrokes.isNotEmpty)
            Positioned.fill(
              child: CustomPaint(
                painter: DrawingPainter(drawingStrokes),
              ),
            ),
          ...
          if (isDrawing)
            Positioned.fill(
              child: GestureDetector(
                ...
                onPanEnd: (details) {
                  setState(() {
                    drawingStrokes.add(DrawingStroke(
                ...
                child: currentStroke.isNotEmpty
                    ? CustomPaint(
            ...
            child: GestureDetector(
              ...
              onScaleUpdate: (details) {
                setState(() {
                  ...
                  // Smooth scaling
                  overlay.scale = (_baseScale * details.scale).clamp(0.5, 5.0);
                  ...
                  if ((overlay.position + const Offset(50, 20) - deleteZone).distance < 60) {
          ...
          ...stickerOverlays.map((sticker) => Positioned(
            ...
            child: GestureDetector(
              ...
              onScaleUpdate: (details) {
                setState(() {
                  // Smooth scaling
                  sticker.scale = (_baseScale * details.scale).clamp(0.5, 5.0);
                  ...
                  final screenH = MediaQuery.of(context).size.height;
                  final screenW = MediaQuery.of(context).size.width;
                  final deleteZone = Offset(screenW / 2, screenH - 75); // Center of trash bin
                  
                  // Distance check (approx center of sticker)
                  final stickerCenter = sticker.position + const Offset(32, 32); 
              ...
              child: Transform.scale(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    border: isDraggingItem ? Border.all(color: Colors.white30, width: 1) : null,
            ...
            Positioned(
              ...
              child: Center(
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    color: isOverDeleteZone ? Colors.red : Colors.black.withOpacity(0.5),
                  ...
                  children: [
                    ...
                    GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () => setState(() => selectedDrawColor = color),
                          child: Container(
                            decoration: BoxDecoration(
                              color: color,
                              shape: BoxShape.circle,
                              border: Border.all(
                                color: selectedDrawColor == color ? Colors.white : Colors.transparent,
                                width: 3,
                              ),
                            ),
                          ),
                    ...
                    Row(
                      ...
                      children: [2.0, 4.0, 6.0, 8.0].map((width) {
                        return GestureDetector(
                          onTap: () => setState(() => drawStrokeWidth = width),
                          child: Container(
                            width: 32,
                            height: 32,
                            decoration: BoxDecoration(
                              color: drawStrokeWidth == width ? Colors.white : Colors.white24,
                              shape: BoxShape.circle,
                            ),
                            child: Center(
                              child: Container(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final category = stickerCategories.keys.elementAt(index);
                      ...
                      Expanded(
                        child: GridView.builder(
                          ...
                          itemCount: stickerCategories[selectedCategory]!.length,
                          itemBuilder: (context, index) {
                            final sticker = stickerCategories[selectedCategory]![index];
                            return GestureDetector(
                              onTap: () {
                                setState(() {
                            ...
                            GestureDetector(
                              onTap: () {
                                setState(() {
                                  ...
                                  } else if (selectedTextAlign == TextAlign.left) {
                                 ...
                                 if (textController.text.isNotEmpty) {
                                  setState(() {
                                    textOverlays.add(TextOverlay(
                                      ...
                                      style: selectedTextStyle, // Use current style
                                      shape: selectedTextShape,
                                      font: selectedFont,
                                      scale: 1.0,
                                      position: Offset(
                                        MediaQuery.of(context).size.width / 2 - 100, // Approximate center
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      if (selectedTextShape == 'None') selectedTextShape = 'Rounded';
                                      else if (selectedTextShape == 'Rounded') selectedTextShape = 'Circle';
                                      else selectedTextShape = 'None';
                                    });
                                  },
                                  child: Container(
                                    padding: const EdgeInsets.all(10),
                                    decoration: BoxDecoration(
                                      color: selectedTextShape != 'None' ? Colors.white : Colors.black.withOpacity(0.5),
                                      borderRadius: BorderRadius.circular(12),
                                      border: Border.all(color: Colors.white30),
                                    ),
                                    child: Icon(
                                      Icons.format_size, // Icon for background/style
                                      color: selectedTextShape != 'None' ? Colors.black : Colors.white,
                                      size: 20,
                                    ),
                                  ),
                                ),
                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: Row(
                                        ...
                                        children: textStyles.map((style) {
                                          final isSelected = selectedTextStyle == style;
                                          return GestureDetector(
                                            onTap: () => setState(() => selectedTextStyle = style),
                                            child: AnimatedContainer(
                                              duration: const Duration(milliseconds: 200),
  ...
  Future<void> _captureAndShare() async {
    try {
      ...
      final file = await File('${tempDir.path}/story_share_${DateTime.now().millisecondsSinceEpoch}.png').create();
  ...
  Widget _buildToolButton({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon, color: Colors.white, size: 20), // Reduced size
      ),
    );
  }
    ...
    switch (overlay.style) {
      ...
      case 'Neon':
        return TextStyle(
          ...
          shadows: [
            Shadow(
              color: overlay.color.withOpacity(0.8),
              blurRadius: 10,
            ),
            Shadow(
              color: overlay.color.withOpacity(0.6),
              blurRadius: 20,
            ),
          ],
        );
      ...
      case 'Neon':
        return TextStyle(
          ...
          shadows: [
            ...
            Shadow(
              color: selectedTextColor.withOpacity(0.6),
              blurRadius: 20,
            ),
          ],
        );
